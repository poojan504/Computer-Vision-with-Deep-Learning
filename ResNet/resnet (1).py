...
history = Resnet.fit(train_data,epochs=20,steps_per_epoch=train_steps_per_epoch,validation_data=val_data,validation_steps=val_steps_per_epoch,verbose=1,callbacks=callbacks)
